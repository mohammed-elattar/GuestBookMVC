            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                <li class="active">
                  ...
                  <li class="dropdown">
                      <a href="<?php echo url('/guestbook'); ?>" class="dropdown-toggle user-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                          Guest Book<span class="caret"></span>
                      </a>
                      <ul class="dropdown-menu">
                          <li>
                              <a href="<?php echo url('/guestbook') ?>">All GuestBook Posts</a>
                          </li>
                          <li>
                              <a href="<?php echo url('/guestbook/create') ?>">Add New GuestBook Post</a>
                          </li>
